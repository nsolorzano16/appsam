...
class EditPlanTerapeuticoPage extends StatefulWidget {
  static final String routeName = 'crear_plan_terapeutico';
  final PreclinicaViewModel preclinica;
  final PlanTerapeuticoViewModel plan;

  const EditPlanTerapeuticoPage(
      {@required this.preclinica, @required this.plan});

  @override
  _EditPlanTerapeuticoPageState createState() =>
      _EditPlanTerapeuticoPageState();
}

class _EditPlanTerapeuticoPageState extends State<EditPlanTerapeuticoPage> {
  ...
  void initState() {
    ...
    _permanente = widget.plan.permanente;
    _nombreMedicamentoController.text = widget.plan.nombreMedicamento;
    _dosisController.text = widget.plan.dosis;
    _horarioController.text = widget.plan.horario;
    _diasRequeridosController.text = widget.plan.diasRequeridos;
    _notasController.text = widget.plan.notas;
    widget.plan.modificadoPor = _usuario.userName;
  }
  ...
  Widget _crearCampoNombreMedicamento() {
    return Padding(
      ...
      child: TextFormField(
        ...
        onSaved: (value) => widget.plan.nombreMedicamento = value,
  ...
  Widget _crearCampoDosis() {
    return Padding(
      ...
      child: TextFormField(
        ...
        autovalidate: true,
        validator: validaTexto,
        onSaved: (value) => widget.plan.dosis = value,
        keyboardType: TextInputType.text,
  ...
  Widget _crearCampoHorario() {
    return Padding(
      ...
      child: TextFormField(
        ...
        autovalidate: true,
        validator: validaTexto,
        onSaved: (value) => widget.plan.horario = value,
        keyboardType: TextInputType.text,
  ...
  Widget _crearCampoPermamente() {
    return SwitchListTile(
        ...
        onChanged: (value) {
          _permanente = value;
          widget.plan.permanente = _permanente;
          setState(() {});
        });
  }
  ...
  Widget _crearCampoDiasRequeridos() {
    return Padding(
      ...
      child: TextFormField(
        ...
        autovalidate: true,
        validator: validaTexto,
        onSaved: (value) => widget.plan.diasRequeridos = value,
        keyboardType: TextInputType.text,
        decoration:
  ...
  Widget _crearCampoNotas() {
    return Padding(
      ...
      child: TextFormField(
        ...
        onSaved: (value) => widget.plan.notas = value,
        maxLines: 2,
        keyboardType: TextInputType.text,
          ...
          return Padding(
            ...
            child: InputDecorator(
              ...
              child: DropdownButtonHideUnderline(
                ...
                value: widget.plan.viaAdministracionId,
                isDense: true,
                onChanged: (value) async {
                  widget.plan.viaAdministracionId = value;
  ...
  void _guardar(BuildContext context, PreclinicaViewModel preclinica) async {
    ...
    if (_nombreMedicamentoController.text.isEmpty &&
      ...
      PlanTerapeuticoViewModel _planGuardado;
      _planGuardado = await _planBloc.updatePlan(widget.plan);
